...
public class CountryCodePicker extends RelativeLayout {
    ...
    int arrowDrawable = DEFAULT_UNSET;
    int borderFlagColor;
...
//            updateFlagToApply();
            ...
            int arrowDrawable;
            arrowDrawable = a.getResourceId(R.styleable.CountryCodePicker_ccp_arrow, DEFAULT_UNSET);
            setArrow(arrowDrawable);
...
//        Log.d(TAG, "getEditText_registeredCarrierNumber");
    ...
    /**
     * set small down arrow of CCP.
     *
     * @param arrowDrawable drawable to apply to arrow
     */
    public void setArrow(int arrowDrawable) {
        this.arrowDrawable = arrowDrawable;
        if (this.arrowDrawable == DEFAULT_UNSET) {
            if (arrowDrawable != DEFAULT_UNSET) {
                imageViewArrow.setImageResource(this.arrowDrawable);
            }
        } else {
            imageViewArrow.setImageResource(this.arrowDrawable);
        }
