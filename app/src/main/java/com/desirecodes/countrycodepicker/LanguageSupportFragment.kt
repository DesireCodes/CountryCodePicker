...
import com.desirecodes.codepicker.CountryCodePicker.Language.*
        ...
        radioGroup.setOnCheckedChangeListener { _, checkedId ->
            when (checkedId) {
                R.id.radioEnglish -> {
                    ...
                    Toast.makeText(context, "Language is updated to ENGLISH", Toast.LENGTH_SHORT)
                        .show()
                }

                R.id.radioJapanese -> {
                    ccp.changeDefaultLanguage(JAPANESE)
                    Toast.makeText(context, "Language is updated to JAPANESE", Toast.LENGTH_SHORT)
                        .show()
                }

                R.id.radioSpanish -> {
                    ccp.changeDefaultLanguage(SPANISH)
                    Toast.makeText(context, "Language is updated to SPANISH", Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
